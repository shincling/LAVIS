...
# caption_model, temp, _ = load_model_and_preprocess(
    # name="blip2_t5", model_type="pretrain_flant5xl", is_eval=True, device=device, pre_model_path= "/data2/shij/codes/BLIP2/LAVIS/lavis/output/BLIP2/Pretrain_stage2_t5/20230306094/checkpoint_199.pth"
# )
model, vis_processors, _ = load_model_and_preprocess(
    # name="blip2_t5", model_type="pretrain_flant5xxl", is_eval=True, device=device, pre_model_path=None 
    ...
    name="blip2_t5", model_type="pretrain_flant5xxl", is_eval=True, device=device, pre_model_path="/data2/shij/codes/BLIP2/LAVIS/lavis/output/BLIP2/Pretrain_stage2_t5/20230309020/checkpoint_99.pth" 
    # name="blip2_t5", model_type="pretrain_flant5xxl", is_eval=True, device=device, pre_model_path="/data2/shij/codes/BLIP2/LAVIS/lavis/output/BLIP2/Pretrain_stage2_t5_xxl/20230314030/checkpoint_9.pth"
)
caption_model = model
# model, vis_processors, _ = load_model_and_preprocess(
...
print("Default caption w/o prompt: \n", caption_model.generate({"image": image, "prompt": "A picture of"}))
# """
...
def notes_list():
    ...
    if request.method == 'POST':
        ...
        caption = caption_model.generate({"image": given_image, "prompt":"A picture of"},use_nucleus_sampling=False,  max_length=300, repetition_penalty=2.0, temp_prompt="skip")[0]
        
        print("caption: ", caption)
        print("prompt: ", prompt)
        response = model.generate_pureLM({"image": given_image, "prompt": "A picture of "+ caption[:300] + ".\n" + prompt},use_nucleus_sampling=True, max_length=100, repetition_penalty=2.0, temp_prompt="skip")
